...
<h3 class='titre-email'>Inscris toi</h3>
<form>
<img class='icon-mail' src='images/mail-bleu.png'/>
    <input class='email-text' type='text' placeholder='Inscris-toi'/>
    <input class='email-button' type='button' value='Envoyer'/>
